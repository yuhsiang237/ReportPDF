...
namespace ReportPDF.Controllers
{
    ...
    public class ReportController : ControllerBase
    {
        ...
        {
            var pdfDocument = new PdfDocument(new PdfWriter(new FileStream("C:/Users/IDEA3C/Documents/report.pdf", FileMode.Create, FileAccess.Write)));
            var document = new Document(pdfDocument);
            var font = PdfFontFactory.CreateFont("C:/WINDOWS/FONTS/KAIU.TTF", PdfEncodings.IDENTITY_H);
